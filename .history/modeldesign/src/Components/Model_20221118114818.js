...
function Model() {
    ...
    return (
        <div className="p-2  justify-center items-center flex flex-col ">
            ...
            <div className="contain rounded-3xl " style={{ backgroundImage: `url(/images/background/background1.jpg)` }}>
                ...
                <div className="hairstyle" style={{ backgroundImage: `url(/images/hairstyle/hairstyle1.png)` }} />
                <div className="necklace" style={{ backgroundImage: "url(/images/necklaces/necklace1.png)" }} />
                ...
                <div className="handbag" style={{ backgroundImage: `url(/images/handbags/handbag1.png)` }} />
