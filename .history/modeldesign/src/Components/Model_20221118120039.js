    ...
    return (
        <div className="p-2  justify-center items-center flex flex-col ">
            ...
            <div className="contain rounded-3xl " style={{ backgroundImage: `url(${background})` }}>
                ...
                <div className="hairstyle" style={{ backgroundImage: `url(${hairstyle})` }} />
                <div className="necklace" style={{ backgroundImage: `url(${necklaces})` }} />
                <div className="bikinitop top-cloth" style={{ backgroundImage: `url(${topclothes})` }} />
