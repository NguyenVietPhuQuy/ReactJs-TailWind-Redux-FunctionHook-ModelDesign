    ...
    return (
        <div className="card hover:bg-zinc-400  bg-zinc-300 rounded-lg p-5 ease-in duration-100">
            ...
            <div className="mt-2">
                ...
                <button className="text-center font-semibold align-items-center p-2 w-full rounded-xl mt-2 bg-gradient-to-r from-lime-500 to-red-500 hover:bg-gradient-to-r from-lime-300 to-red-300" >Try</button>
            </div>
        </div>
    )
}
